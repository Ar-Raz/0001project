    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.CharField(blank=True, max_length=15, null=True, unique=True, validators=[users.validators.validate_phone_number])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categoty', models.ManyToManyField(blank=True, to='categories.Category')),
            ],
            bases=('users.profile',),
        ),
    ]
