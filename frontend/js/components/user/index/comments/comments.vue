...
<script>
    export default{
        mounted(){
            ...
            // // marquee.setAttribute("--", value: DOMString)
            // const allTwinComments=document.querySelectorAll('.singleTwinComment')
            // console.log(allTwinComments.length)
            // marquee.style.transform = `translateX(-${shouldGoLeft}px)`
            // const com=getComputedStyle(marquee)
            // console.log(com.width)
        }
    }
